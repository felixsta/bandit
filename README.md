...
## Part 21. # 🕰️ Хроники автоматизации: Под капотом расписания ⚙️.
...
## Part 22. # 📅 Расписание Разгадано: В поисках shell-скрипта 👨‍💻.
...
## Part 23. # `Cron`-Hack: Твори, создавай, и... про резервную копию не забывай! 
...
## Part 24. # Твой Первый Брут-Форс 🤖🛠️: Жизнь уже не будет прежней. 🔐🔢
...
## Part 25. #  ❄️ Оболочка вьюг...Влететь — просто, выбраться — Ледяной лабиринт 🌀.
...
## Part 26. 🎩 Советы Бывалых: Воспользовался reverse shell? Теперь Вперед за ~~root'ом~~ флагом! 🏴‍☠️
...
## Part 27. 🎮 Git'овые игры: 🔑 К ключу сквозь исходники! 🔍
...
## Part 28. 🎮 Git'овые игры: 🔑 К ключу сквозь исходники! - 1 🔍 
...
## Part 28. 🎮 Git'овые игры: 🔑 К ключу сквозь исходники! - 2 🔍 

**== Задание ==**


Есть репозиторий Git по адресу ssh://bandit29-git@localhost/home/bandit29-git/repo через порт 2220. Пароль для пользователя bandit29-git такой же, как и для пользователя bandit29.
