...
Эта игра, как и большинство других, организована по уровням. Вы начинаете с уровня 0 и пытаетесь его "пройти" или "завершить". Завершение уровня приводит к информации о том, как начать следующий уровень. Страницы на этом веб-сайте [OverTheWire](https://www.google.com](https://overthewire.org/wargames/bandit/) "OverTheWire")
